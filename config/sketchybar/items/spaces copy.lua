...
-- Change this to a table indexed by workspace name for easier lookup
local spaces = {}
...
for i, workspace in ipairs(workspaces) do
    ...
    -- Store the space object using the workspace name as the key
    spaces[workspace] = space

    -- Define the icons for open apps on each space initially
    -- Change 'i' to 'workspace' in the sbar.exec command
    ...
    -- Change 'i' to 'workspace' for the item name
...
space_window_observer:subscribe("space_windows_change", function(env)
    for _, workspace in ipairs(workspaces) do
        ...
        sbar.exec("aerospace list-windows --workspace " .. workspace .. " --format '%{app-name}' --json ", function(apps)
            ...
            sbar.animate("tanh", 10, function()
                -- Change 'spaces[i]' to 'spaces[workspace]'
